...
CUDA_VISIBLE_DEVICES=0,1 python3 -u train_simple.py --epochs $epochs --batch_size $batch_size --scheduler $scheduler \
                        ...
                        --min_lr $min_lr --max_lr $max_lr --learning_rate $lr
